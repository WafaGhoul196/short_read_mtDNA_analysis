...
echo -e "${GREEN}${BOLD}╚══════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "Activate the environment and run the pipeline:"
echo ""
echo -e "  ${BOLD}conda activate mtdna_pipeline${NC}"
echo ""
echo -e "  ${BOLD}bash run_pipeline.sh \\${NC}"
echo -e "  ${BOLD}  -c <samples.csv> \\${NC}"
echo -e "  ${BOLD}  -b <DRAGEN_results_dir> \\${NC}"
echo -e "  ${BOLD}  -o <output_dir> \\${NC}"
echo -e "  ${BOLD}  -r reference/sequence.fasta \\${NC}"
echo -e "  ${BOLD}  -H /usr/local/bin/haplogrep3 \\${NC}"
echo -e "  ${BOLD}  -t 16${NC}"
echo ""
